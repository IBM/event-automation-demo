...
**Note:** Resource names shown above use the default instance name `my-kafka-cluster`. Actual names will vary if you configure a custom `eventstreams_instance_name` variable.
